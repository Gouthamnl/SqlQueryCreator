...
{
    // The list in this container will contain lists of clauses to form a where statement
    public class WhereStatement : List<List<WhereClause>>
    {
        ...
        public WhereClause Add(string field, Comparison operation, object compareValue) 
        { 
            return this.Add(field, operation, compareValue, 1); 
        }
        public WhereClause Add(Enum field, Comparison operation, object compareValue) 
        { 
            return this.Add(field.ToString(), operation, compareValue, 1); 
        }
        public WhereClause Add(string field, Comparison operation, object compareValue, int level)
        {
        ...
        /// <summary>
        /// combine all where clause to form a statement
        /// </summary>
        ...
        public string BuildWhereStatement(bool useCommandObject, ref DbCommand usedDbCommand)
        {
            ...
            foreach (List<WhereClause> WhereStatement in this) // Loop through all statement levels, OR them together
            {
                ...
                LevelWhere = LevelWhere.Substring(0, LevelWhere.Length - 5); // Trim the last AND inserted by foreach loop
            ...
            Result = Result.Substring(0, Result.Length - 2); // Trim the last OR inserted by foreach loop

            return Result;
        }

        /// <summary>
        /// single function to add comparision logic
        /// </summary>
        ...
        /// <summary>
        /// Formatting SQL value to avoid conversion issues
        /// </summary>
        ...
        internal static string FormatSQLValue(object someValue)
        {
            ...
            {
                FormattedValue = someValue.GetType().Name switch
                {
                    "String" => "'" + ((string)someValue).Replace("'", "''") + "'",
                    "DateTime" => "'" + ((DateTime)someValue).ToString("yyyy/MM/dd hh:mm:ss") + "'",
                    "DBNull" => "NULL",
        ...
        /// Helpful duing multiple logical operations in where clause
        /// </summary>
        ...
        public static WhereStatement CombineStatements(WhereStatement statement1, WhereStatement statement2)
        {
            ...
            WhereStatement result = Clone(statement1);
        ...
        /// <summary>
        /// Clone where statement for combining with other
        /// </summary>
        /// <param name="statement"></param>
        /// <returns></returns>
        public static WhereStatement Clone(WhereStatement statement)
        {
